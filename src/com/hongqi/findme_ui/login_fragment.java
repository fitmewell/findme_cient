	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		spinner.setVisibility(View.GONE);
		 sp = getActivity().getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
	        ...
	        Toast.makeText(getActivity(),String .valueOf(sp.getString("username","")),Toast.LENGTH_SHORT).show();
	        if(autoLogined){
	            success(sp.getString("username",""),sp.getString("password",""),true,true);
	        }
		...
		loginbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				success(username.getText().toString(),password.getText().toString(),remenPass.isChecked(),autoLogin.isChecked());
		...
		registerBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
				getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.active_main, r).commit();
			}
		});
...
//		Toast.makeText(getActivity(), "Destroy", Toast.LENGTH_LONG).show();
	 ...
	 public void success(String username_,String password_, Boolean isRemPass,Boolean loginChecked){
...
//		            Toast.makeText(getActivity(),String.valueOf(isRemPass)+String.valueOf(sp.getBoolean("autologin",false))+sp.getString("username",""),Toast.LENGTH_SHORT).show();
		            mycallback.onLoginSuccess(returnM, username_);
		    		 ...
		    		 Toast toast = Toast.makeText(getActivity(), "用户名或者密码错误", Toast.LENGTH_SHORT);
		    	        toast.show();
		    	}
		    }
}
